...
It may render specs and content from Flow package exports, but canonical product rules, component contracts, content fixtures, and audit gates must stay outside `apps/docs`.
