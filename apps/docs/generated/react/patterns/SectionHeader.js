...
function resolveState({ disabled, permissionBlocked, loading, dirty, actions, state }) {
    ...
    if (dirty || state === "dirty")
        return "dirty";
    if ((actions?.length ?? 0) > 0 || state === "actionable")
        return "actionable";
...
export const SectionHeader = forwardRef(function SectionHeader({ title, description, headingLevel = 2, density, state, loading = false, disabled = false, dirty = false, permissionBlocked = false, badge, tag, actions = [], overflow, toolbar, settings, formSection, className = "", ...rest }, ref) {
    ...
    return React.createElement("div", {
        ...
        : React.createElement(Heading, null, title), description ? React.createElement("p", null, description) : null, badge
