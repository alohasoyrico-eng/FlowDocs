...
export const BottomSheet = forwardRef(function BottomSheet({ label, description, density, state, open = false, dragging = false, loading = false, invalid = false, destructive = false, permissionBlocked = false, disabled = false, triggerLabel, closeLabel = "Close", items = [], actions = [], validation, drawer, className = "", onOpenChange, onAction, onSelect, ...rest }, ref) {
    ...
    return React.createElement(Surface, {
        ...
        : null, normalizedItems.length && !open
        ...
        : null, normalizedActions.length && !open
        ? React.createElement("div", { "data-flow-slot": "actions" }, normalizedActions.map((action) => React.createElement(Button, {
            ...action,
