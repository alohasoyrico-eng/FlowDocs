...
export const ChartLegendItem = forwardRef(function ChartLegendItem({
  label,
  value,
  description,
  colorLabel,
  ...
  const handleToggle = (nextChecked, meta, event) => {
    onToggle?.(nextChecked, { label, hidden: !nextChecked, state: resolvedState, meta }, event);
  };
  ...
  return React.createElement(
    ...
    status?.label ? React.createElement(Badge, { ...status, density: status.density ?? density, "data-flow-slot": "status" }) : null,
    tag?.label ? React.createElement(Tag, { ...tag, density: tag.density ?? density, "data-flow-slot": "status" }) : null,
    tooltip?.label ? React.createElement(Tooltip, { ...tooltip, density: tooltip.density ?? density, "data-flow-slot": "status" }) : null,
