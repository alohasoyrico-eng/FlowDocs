...
export const PricingOperations = forwardRef(function PricingOperations({
  ...
  const normalizedRules = normalizeArray(rules).filter((rule) => rule?.name);
