...
const validKinds = new Set(["empty", "error", "inline", "toast", "notifications", "snackbar", "loading", "permission", "maintenance"]);
...
function normalizeKind(kind, state) {
  if (validKinds.has(kind)) return kind;
...
export const StatusFeedbackView = forwardRef(function StatusFeedbackView({
  kind,
  ...
  if (resolvedKind === "notifications") {
    ...
    content = React.createElement(InlineValidation, {
      ...
      state: resolvedState === "success" || resolvedState === "warning" || resolvedState === "error" || resolvedState === "disabled" ? resolvedState : "info",
      field,
      live,
      density,
    });
    ...
    content = React.createElement(Toast, {
      ...
      variant: action?.label ? "recovery" : resolvedState === "warning" ? "warning" : "status",
      state: action?.label ? "action" : "visible",
      density,
  ...
  return React.createElement(
    Surface,
    {
      ...
      className,
      surfaceRole: "section",
      state: resolvedState === "disabled" ? "disabled" : resolvedState === "error" || resolvedState === "critical" ? "raised" : "default",
      density,
      elevation: "none",
