...
export const ConfirmationDialog = forwardRef(function ConfirmationDialog({ label, description = "", triggerLabel, closeLabel, open = false, density, state = "closed", tone = "neutral", destructive = false, disabled = false, loading = false, confirm, cancel, recovery, validation, feedback, onOpenChange, onConfirm, onCancel, onRecoveryAction, className = "", ...rest }, ref) {
    ...
    return React.createElement("div", {
        ...
        : null, recovery?.secondaryAction?.label
