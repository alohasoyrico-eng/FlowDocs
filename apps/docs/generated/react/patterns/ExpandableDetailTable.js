...
function resolveState({ disabled, loading, error, expandedRowKey, detailOpen, rows, state, }) {
    ...
    if (detailOpen || state === "detail-open")
        return "detail-open";
    if (expandedRowKey || state === "expanded")
        return "expanded";
...
function surfaceStateFor(resolvedState) {
    ...
    if (resolvedState === "loading")
        return "sunken";
    if (resolvedState === "expanded" || resolvedState === "detail-open")
        return "selected";
    return "default";
}
...
export const ExpandableDetailTable = forwardRef(function ExpandableDetailTable({ label = "Expandable detail table", description, density = "sm", state, disabled = false, loading = false, error, expandedRowKey, detailOpen = false, summaries = [], table = {}, detail, feedback, className = "", onTableSortChange, onTableRowSelect, onTablePageChange, onTableBulkAction, onDetailOpenChange, onDetailAction, onFeedbackAction, ...rest }, ref) {
