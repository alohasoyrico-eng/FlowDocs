...
export const FileUpload = forwardRef(function FileUpload({ label, description, density, state, disabled = false, loading = false, multiple = false, files = [], progress, chooseAction, removeAction, retryAction, empty, validation, feedback, onChoose, onRemove, onRetry, className = "", ...rest }, ref) {
    ...
    return React.createElement("div", {
        ...
        }, React.createElement("h3", null, title), React.createElement("p", null, description ?? fileLabel(firstFile)), React.createElement("p", null, selectedCount > 1 ? `${selectedCount} files selected` : fileLabel(firstFile)), React.createElement(Tag, {
            label: statusLabel,
