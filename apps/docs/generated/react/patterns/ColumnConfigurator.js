...
function renderOverlay({ label, description, density, open, surface, resolvedState, actions, isDisabled, visibleCount, totalCount, onOpenChange, onMenuSelect, }) {
...
export const ColumnConfigurator = forwardRef(function ColumnConfigurator({ label = "Column configurator", description, density, state, disabled = false, open = false, saving = false, invalid = false, surface, columns = [], visibleKeys = [], defaultVisibleKeys = [], rows = [], rowKey = "id", table, applyAction, resetAction, saveViewAction, cancelAction, validation, feedback, className = "", onOpenChange, onColumnVisibilityChange, onAction, ...rest }, ref) {
    ...
    return React.createElement("div", {
        ...
        : null, actions.map((action, index) => React.createElement(Button, {
        ...action,
        key: action.key ?? action.label,
        label: action.label,
