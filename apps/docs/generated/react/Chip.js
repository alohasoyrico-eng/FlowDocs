...
export const Chip = forwardRef(function Chip({ label, variant = "filter", tone = "default", state = "default", density, selected = false, disabled = false, removable = false, icon = "", interactive = false, onRemoveLabel, onRemove, onSelectedChange, className = "", type = "button", ...rest }, ref) {
    ...
    }, icon ? React.createElement("span", { className: "chip__icon", "aria-hidden": "true" }, icon) : null, React.createElement("span", { className: "chip__label" }, label), canRemove ? React.createElement("span", { className: "chip__remove", "data-chip-remove-icon": "true", "aria-hidden": "true" }, "close") : null);
});
