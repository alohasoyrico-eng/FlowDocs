...
export const MovementRow = forwardRef(function MovementRow({ label, meta, amount, status, category = "transfer", variant = "standard", state = "default", density, fullWidth = false, disabled = false, onSelect, className = "", type = "button", ...rest }, ref) {
    ...
    return React.createElement(Element, {
        ...
        onClick: canInteract
            ...
            : undefined,
    }, React.createElement("span", { className: "movement-row__icon material-symbol", "aria-hidden": "true" }, categoryIcons[resolvedCategory]), React.createElement("span", { className: "movement-row__content" }, React.createElement("strong", null, label), meta ? React.createElement("small", null, meta) : null), React.createElement("span", { className: "movement-row__value" }, amount ? React.createElement("strong", { className: "movement-row__amount" }, amount) : null, status ? React.createElement("small", { className: "movement-row__status" }, status) : null));
});
