...
export const AnimatedMoment = forwardRef(function AnimatedMoment({ label, description, variant = "success", state = "playing", density, fullWidth = false, icon = "", animationSource, animationData, reducedMotionFallback, stateLabel, className = "", ...rest }, ref) {
