...
export const Switch = forwardRef(function Switch({ label, description, error, state = "off", density, checked, disabled = false, name = "", required = false, onCheckedChange, className = "", ...rest }, ref) {
    ...
    }), React.createElement("span", { className: "switch__track", "aria-hidden": "true" }, React.createElement("span", { className: "switch__thumb" })), React.createElement("span", { className: "switch__text" }, React.createElement("span", { className: "switch__label" }, label), description ? React.createElement("span", { className: "switch__description" }, description) : null, error ? React.createElement("span", { className: "switch__error" }, error) : null));
});
