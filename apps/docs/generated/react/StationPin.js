...
export const StationPin = forwardRef(function StationPin({ label, value = "", meta, icon = "local_gas_station", count, variant = "fuel", state = "default", density, selected = false, unavailable = false, disabled = false, className = "", onSelect, onClick, ...rest }, ref) {
    ...
    }, markerCount != null ? String(markerCount) : icon), markerCount == null && visibleValue ? React.createElement("span", { className: "station-pin__value" }, visibleValue) : null);
});
