...
export const Button = forwardRef(function Button({ label, children, variant = "primary", intent = "default", density, state = "default", disabled = false, loading = false, icon, trailingIcon, fullWidth = false, type = "button", className = "", ...rest }, ref) {
    ...
    return React.createElement("button", {
        ...
        : null, buttonLabel ? React.createElement("span", { className: "button__label" }, buttonLabel) : null, resolvedState !== "loading" && trailingIcon
