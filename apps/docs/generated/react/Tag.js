...
export const Tag = forwardRef(function Tag({ label, variant = "metadata", tone = "neutral", state = "default", density, icon = "", interactive = false, disabled = false, className = "", type = "button", ...rest }, ref) {
    ...
    }, icon ? React.createElement("span", { className: "tag__icon", "aria-hidden": "true" }, icon) : null, React.createElement("span", { className: "tag__label" }, label));
});
Tag.displayName = "Tag";
