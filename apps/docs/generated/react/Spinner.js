...
export const Spinner = forwardRef(function Spinner({ label, density, tone = "accent", state = "loading", decorative = false, className = "", ...rest }, ref) {
    ...
    return React.createElement("span", {
        ...
        focusable: "false",
        "aria-hidden": "true",
    }, React.createElement("circle", { className: "spinner__track", cx: "20", cy: "20", r: "16", pathLength: "100" }), React.createElement("circle", { className: "spinner__arc", cx: "20", cy: "20", r: "16", pathLength: "100" })));
});
