...
export const DatePicker = forwardRef(function DatePicker({ label, value, placeholder = "", helper = "", error = "", disabled = false, min = "", max = "", density, state, invalid = false, locale, weekdays, calendarLabel, previousMonthLabel, nextMonthLabel, open: openProp, onValueChange, onOpenChange, className = "", id, ...rest }, ref) {
    ...
    return React.createElement("div", {
        ...
        onClick: () => moveMonth(-1),
    }, React.createElement("span", { className: "field__icon date-picker__icon", "aria-hidden": "true" }, "chevron_left")) : null, React.createElement("strong", { id: monthId, "data-date-picker-month": "" }, formatMonthLabel(viewDate, locale)), nextMonthLabel ? React.createElement("button", {
        type: "button",
        className: "date-picker__nav",
