...
export const DocsHomeTemplate = forwardRef(function DocsHomeTemplate({ title, description, metadata = [], coverage, status, children, density = "md", state = "default", className = "", ...rest }, ref) {
