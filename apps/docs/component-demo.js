...
export function componentDemo(component, demo = {}) {
  ...
  if (component === "animated-moment") return reactAnimatedMomentDemo(demo); if (component === "audit-event") return reactAuditEventDemo(demo);
  if (component === "badge") return reactBadgeDemo(demo); if (component === "biometric-prompt") return reactBiometricPromptDemo(demo);
  ...
  if (component === "station-pin") return reactStationPinDemo(demo);
